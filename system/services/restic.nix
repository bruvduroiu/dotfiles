...
let
  # Storage Box configuration (account identifiers in private flake vars)
  inherit (inputs.secrets.vars.restic) storageBoxUser storageBoxHost;
  ...
  secretsFile = "${inputs.secrets}/secrets/framework13/backup.yaml";
